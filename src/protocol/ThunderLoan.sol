...
contract ThunderLoan is Initializable, OwnableUpgradeable, UUPSUpgradeable, OracleUpgradeable {
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // q what if we deploy the conttract and someone else initializes it?
    ...
    // @audit-low you can't use repay to repay the loan inside another flash loan
    ...
    function getCalculatedFee(IERC20 token, uint256 amount) public view returns (uint256 fee) {
        ...
        // @audit-high if the fee is going to be in token then the value should reflect that and not in WETH
